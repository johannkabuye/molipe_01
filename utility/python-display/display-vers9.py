...
class DualRing(tk.Frame):
    ...
    def _redraw(self) -> None:
        ...
        # Calculate padding for extra arcs (they go outside the outer arc)
        extra_arc_width = RING_EXTRA_ARC_WIDTH
        extra_arc1_pad = outer_pad - self._w_outer - extra_arc_width - 2
        extra_arc2_pad = extra_arc1_pad - extra_arc_width - 2

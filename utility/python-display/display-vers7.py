...
class DualRing(tk.Frame):
    ...
    def _redraw(self) -> None:
        ...
        # Background tracks - make them visible with a dark grey instead of pure black
        self.canvas.create_oval(*outer_bbox, outline="#1a1a1a", width=self._w_outer)
        self.canvas.create_oval(*inner_bbox, outline="#1a1a1a", width=self._w_inner)

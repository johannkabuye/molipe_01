...
Pure Data must be run with sudo in order to allow the patch to open new subpatches.

To start Molipe, open the file mother.pd. From within mother.pd, you can load various patches.
